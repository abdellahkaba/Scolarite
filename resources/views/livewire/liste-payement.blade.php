<div class="mt-5">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-2">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('payements.create') }}" class="text-white text-sm bg-blue-600 rounded-md p-2 m-2">Faire un paiement</a>
        </div>
                        ...
                        <table class="min-w-full text-center">
                            <thead class="border-b bg-gray-300">
                                <tr>
                                    ...
                                    <th class="text-sm font-medium text-gray-900 px-6 py-6">Elève</th>
                                    ...
                                    <th class="text-sm font-medium text-gray-900 px-6 py-6">Date du paiement</th>
                                    <th class="text-sm font-medium text-gray-900 px-6 py-6">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse ($payements as $item)
                                    <tr class="border-b-2 border-gray-100">
                                        <td class="text-sm font-medium text-gray-900 px-6 py-6">{{ $item->student->matricule }}</td>
                                        <td class="text-sm font-medium text-gray-900 px-6 py-6">{{ $item->student->prenom }} {{ $item->student->nom }}</td>
                                        ...
                                        <td class="text-sm font-medium text-gray-900 px-6 py-6">
                                            <a href="{{ route('payements.edit', $item->id) }}" class="text-sm bg-blue-500 p-1 text-white rounded-sm">Imprimer</a>
