<div class="mt-5">
    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-2">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('classes.create') }}" class="text-white text-sm bg-blue-600 rounded-md p-2 m-2">Ajouter une classe</a>
        </div>
                            ...
                            <tbody>
                                @forelse ($classes as $item)
                                    <tr class="border-b-2 border-gray-100">
                                        ...
                                        <td class="text-sm font-medium text-gray-900 px-6 py-6">
                                            {{ $item->level->scolarite }} FG
                                         </td>
                                        <td class="text-sm font-medium text-gray-900 px-6 py-6">
                                            <a href="{{ route('classes.edit', $item->id) }}" class="text-sm bg-green-500 p-1 text-white rounded-sm">Modifier</a>
