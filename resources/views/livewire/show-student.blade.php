        ...
        <div class="w-2/3">
            <div class="custom_card p-3 bg-white rounded-md">
                ...
                <section class="flex mt-2">
                    <div class="div w-24">
                        <img src="https://ui-avatars.com/api/?name={{ $student->prenom }}+{{ $student->nom }}" alt="" class="w-24">
                    </div>
                    <section class="flex flex-col">
                        <div class="flex flex-row pl-3">
                            <div class="name  mr-2 uppercase">Matricule:</div>
                            <div class="name text-md">{{ $student->matricule}}</div>
                        </div>
                        <div class="flex flex-row pl-3">
                            <div class="name font-bold mr-2">{{ $student->prenom }}</div>
                            <div class="name font-bold">{{ $student->nom }}</div>
                        </div>
                        <div class="flex flex-row pl-3">
